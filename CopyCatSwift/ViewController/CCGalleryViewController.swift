...
@objc class CCGalleryViewController: UIViewController, CCPhotoCollectionManipulation {
    ...
    override func viewDidLoad() {
        ...
        cancelButton.addTarget(self, action: #selector(CCGalleryViewController.finishDelete), forControlEvents: .TouchUpInside)
        ...
        deleteButton.addTarget(self, action: #selector(CCGalleryViewController.performDelete), forControlEvents: .TouchUpInside)
