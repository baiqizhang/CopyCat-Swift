...
+ (UIImage *)combineImage:(UIImage *)image1 withImage:(UIImage *)image2 orientation:(int32_t)imageOrientation;{
  if (imageOrientation == -90){
    ...
    CGSize size = CGSizeMake(image1.size.width + image2.size.width/image2.size.height*image1.size.height, image1.size.height);
    
    UIGraphicsBeginImageContext(size);
    
    [image1 drawInRect:CGRectMake(0,0,image1.size.width, image1.size.height)];
    [image2 drawInRect:CGRectMake(image1.size.width, 0 , image2.size.width/image2.size.height*image1.size.height, size.height)];
